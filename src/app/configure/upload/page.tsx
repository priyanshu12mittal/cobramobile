...
import { Loader2, MousePointerSquareDashed,Image, Upload} from "lucide-react";
...
const Page = ()=>{
    ...
    const [uploadProgress,seUploadProgress] = useState<number>(0);
    ...
    return (
        <div className={cn("relative h-full flex-1 my-16 w-full rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",{
